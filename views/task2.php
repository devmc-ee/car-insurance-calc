...
<div class="task-result">
    <div class="task-form__wrapper">
        ...
        <form id="calculator" class="calculator-form" action="tasks_solutions/task2/form-action.php" method="post">
            ...
            <input id="taxPercentage" name="taxPercentage" type="number" min="0" max="100" placeholder="0 - 100%"
                   value="">

            <label for="instalmentsNumber"> Number of instalments (count of payments in which client wants to pay for
                the
                policy (1 – 12))</label>
